...
{
	public class MultiplicationIntNode : OperatorNode<int>
	{
		public MultiplicationIntNode(int id, Vector2 position, string title = "MultiplicationIntNode") : base(id, position, title)
		{
