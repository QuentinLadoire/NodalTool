...
{
	public class SubstractionIntNode : OperatorNode<int>
	{
		public SubstractionIntNode(int id, Vector2 position, string title = "SubstractionIntNode") : base(id, position, title)
		{
