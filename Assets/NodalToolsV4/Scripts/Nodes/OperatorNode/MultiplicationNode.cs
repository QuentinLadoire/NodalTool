...
{
	public class MultiplicationNode<T> : OperatorNode<T>
	{
		public MultiplicationNode(int id, Vector2 position, string title = "MultiplicationIntNode") : base(id, position, title)
		{
		}
